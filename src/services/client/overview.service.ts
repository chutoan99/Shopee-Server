...
const OverviewService = {
  ...
  GetOverviewId: async (itemid: string) => {
    try {
      ...
      throw new Error('Failed to get Overview id.')
    }
  },

  AddOverview: async (payload: any, fileData: any) => {
    try {
      ...
      throw new Error('Failed to add Overview id.')
    }
  },

  UpdateOverview: async (itemid: any, payload: any, fileData: any) => {
    try {
      if (fileData) {
      ...
      if (fileData) cloudinary.uploader.destroy(fileData.filename)
      throw new Error('Failed to update Overview id.')
    }
  },

  DeleteOverview: async (itemid: string, fileName: any) => {
    try {
      ...
      throw new Error('Failed to Delete Overview id.')
    }
  }
}
